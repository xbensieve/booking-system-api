...
namespace Booking.Application.Interfaces
{
    ...
    {
        Task<ApiResponse<object>> CreateReservationAsync(Guid userId, ReservationRequest request);
        ...
        Task<ApiResponse<List<ReservationResponse>>> GetReservationsByUserIdAsync(Guid userId, int page, int pageSize);
